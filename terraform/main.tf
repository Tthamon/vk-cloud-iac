...
module "network" {
  ...
  private_web_subnet_cidr = var.private_cidr
...
module "security" {
  ...
  bastion_subnet_cidr = var.public_cidr
  web_subnet_cidr     = var.private_cidr
}
...
module "database" {
  ...
  project_name                = var.project_name
  db_flavor_name              = var.db_flavor
  disk_size                   = var.disk_size
  db_version                  = var.postgre_version
  network_id                  = module.network.network_id
